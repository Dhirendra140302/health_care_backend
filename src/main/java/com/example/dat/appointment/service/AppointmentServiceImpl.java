...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public Response<AppointmentDTO> bookAppointment(AppointmentDTO appointmentDTO) {
        ...
        try {
            ...
            log.error("Failed to send appointment confirmation emails: {}", e.getMessage());
    ...
    public Response<List<AppointmentDTO>> getMyAppointments() {
        ...
        // Check for "ADMIN" role - admins can see all appointments
    ...
    public Response<AppointmentDTO> cancelAppointment(Long appointmentId) {
        ...
        try {
            ...
            log.error("Failed to send appointment cancellation emails: {}", e.getMessage());
            // Continue - appointment is already cancelled
        }
